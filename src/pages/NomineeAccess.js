...
export default function NomineeAccess() {
  ...
  return (
    <div className="min-h-screen bg-dark-bg text-white">
      ...
      {/* Minimal header — no login/logout, just branding */}
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="bg-primary bg-opacity-10 border border-primary border-opacity-30 rounded-2xl p-6 mb-8">
          ...
          <p className="text-sm text-gray-300 leading-relaxed mb-4">
            ...
            for storing wills and legal documents on the blockchain. Because they missed their
            scheduled check-in, you now have temporary access to the files they chose to share
            with you.
          </p>
